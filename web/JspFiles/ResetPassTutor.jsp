...
<html>
    <head>
          <base href="/Project/HtmlFiles/ResetPassForm.html">
        ...
        <%
              ...
              String sq2= request.getParameter("sq2"); 
    			...
    			Connection con= DriverManager.getConnection("jdbc:postgresql://localhost:5432/Project","postgres","1234");
    						String query= "select * from regtutor where username=? and sq1=? and sq2=?";
    						...
    						%>
    						<jsp:forward page="/HtmlFiles/NewPassTutor.html"/>
    						<%
    						}
    						else
    						{
    						 %>
    						 <jsp:forward page="/HtmlFiles/ResetPassForm.html"/>
    						 <%
    						 }
    						  %>
